<?php
namespace App\Vendor\BrowserDetect;
...
class Parser
{
    ...
    public function __construct(Application $app)
    {
        ...
        $this->objectConfigImport(require __DIR__ . '/config/config.php');

        // Import the plugins.
        $this->pluginCollectionImport(require __DIR__ . '/config/plugins.php');
    }
